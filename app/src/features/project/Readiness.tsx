        ...
        <div className="ws-empty">
          ...
          <div className="ws-empty__steps">
            <span className="ws-empty__step">
              <span className="ws-empty__num">1</span>Confirm checklist
            </span>
            <span className="ws-empty__step">
              <span className="ws-empty__num">2</span>Run scan
            </span>
            <span className="ws-empty__step">
              <span className="ws-empty__num">3</span>Review passes &amp; gaps
            </span>
          </div>
        </div>
          ...
          <section className="ws-panel">
            ...
            <div className="rs-doclist">
              <div className="rs-doc">
                ...
                <span>Executive summary v2.pdf</span>
              </div>
              <div className="rs-doc">
                <Icon name="file" size={14} />
                <span>Arena stage gate report.pdf</span>
              </div>
            </div>
          </section>
          <section className="ws-panel">
            ...
            <div className="scan-field">
              <button
                ...
                type="button"
                onClick={() => toast('The stage gate is fixed for this prototype')}
              >
                <span>
                  Stage Gate&nbsp;&nbsp;<strong>SG3</strong>
                </span>
            ...
            <div className="scan-field">
              <button
                className="scan-select"
                type="button"
                onClick={() => toast('Only checklist SG3 · v2.1 is available')}
              >
                <span>
                  Checklist&nbsp;&nbsp;<strong>SG3 · v2.1</strong>
                </span>
                <Icon name="chevronDown" size={14} strokeWidth={2.2} className="scan-select__ch" />
              </button>
            </div>
